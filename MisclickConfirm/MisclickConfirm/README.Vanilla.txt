...
- Unfortunately, it overrides XComTacticalInput, so it's not compatible with Long War 2 or other mods which change camera behavior. Looking into alternatives
- Although the pop up is no longer shown every single time you move out of cover, I think it can still be made less annoying. Some ideas that were suggested that I may try to add include an override toggle and ignoring melee-only units (the WOTC version ignores Lost, which is easier than ignoring based on ability, as the Lost are a category of units)
